...
@Getter
@ConstantType
public enum CommonDefaultType implements ISuperType {
    /**
     * 默认模块类型
     */
    MODULE_DEFAULT("common", "默认业务"),
    ;
    ...
    CommonDefaultType(String code, String describe) {
        this.code = code;
    ...
    public static boolean isHaveByType(String code) {
        CommonDefaultType[] values = CommonDefaultType.values();
        for (CommonDefaultType value : values) {
     ...
     * @date 2020-09-11 16:02
     */
    public static CommonDefaultType getByState(String code) {
        CommonDefaultType[] values = CommonDefaultType.values();
        for (CommonDefaultType value : values) {
            if (value.code.equals(code)) {
                return value;
    ...
    public static String getAllType() {
        ...
        for (CommonDefaultType value : values) {
            sb.append("、").append(value.code).append("(").append(value.describe).append(")");
        }
