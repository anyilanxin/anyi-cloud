...
/**
 * 流程监听(DesignListen)PageVo与Entity相互转换
 *
 * @author zxiaozhou
 * @since 2021-02-12 20:18:19
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE, builder = @Builder(disableBuilder = true))
public interface DesignListenPageVoMap extends BaseMap<DesignListenPageVo, DesignListenEntity> {
}
