...
package com.anyilanxin.cloud.corecommon.utils.encryption;
...
public class RSAUtils {
    ...
    public static String decryptPublicKey(String publicKey, String ciphertext) {
        RSA rsa = new RSA(null, publicKey);
        return StrUtil.str(rsa.decrypt(ciphertext, KeyType.PublicKey), CharsetUtil.UTF_8);
    }
    ...
    public static String decryptPrivateKey(String privateKey, String ciphertext) {
        RSA rsa = new RSA(privateKey, null);
        return StrUtil.str(rsa.decrypt(ciphertext, KeyType.PrivateKey), CharsetUtil.UTF_8);
    }
}
