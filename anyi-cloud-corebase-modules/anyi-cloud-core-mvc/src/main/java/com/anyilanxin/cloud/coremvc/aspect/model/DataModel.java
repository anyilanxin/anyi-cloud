...
package com.anyilanxin.cloud.coremvc.aspect.model;
...
public class DataModel implements Serializable {
    ...
    @Schema(name = "dataContent", title = "数据内容", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotBlankOrNull(message = "数据内容不能为空")
    private String dataContent;

    @Schema(name = "fileName", title = "调用文件名", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotBlankOrNull(message = "调用文件名不能为空")
    private String fileName;

    @Schema(name = "methodName", title = "调用方法名", requiredMode = Schema.RequiredMode.REQUIRED)
