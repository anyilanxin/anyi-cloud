...
package com.anyilanxin.cloud.auth.oauth2.config;


import com.anyilanxin.cloud.auth.modules.login.service.impl.PasswordUserDetailsService;
import com.anyilanxin.cloud.auth.modules.login.service.impl.PhoneUserDetailsService;
import com.anyilanxin.cloud.auth.oauth2.authentication.tokenendpoint.password.AnYiOAuth2PasswordAuthenticationConverter;
import com.anyilanxin.cloud.auth.oauth2.authentication.tokenendpoint.password.AnYiOAuth2PasswordAuthenticationProvider;
import com.anyilanxin.cloud.auth.oauth2.authentication.tokenendpoint.sms.AnYiOAuth2SmsAuthenticationConverter;
import com.anyilanxin.cloud.auth.oauth2.authentication.tokenendpoint.sms.AnYiOAuth2SmsAuthenticationProvider;
import com.anyilanxin.cloud.auth.oauth2.config.property.AnYiCustomSecurityProperties;
import com.anyilanxin.cloud.auth.oauth2.federation.FederatedIdentityIdTokenCustomizer;
import com.anyilanxin.cloud.auth.oauth2.repository.redis.authorization.RedisOAuth2AuthorizationService;
import com.anyilanxin.cloud.auth.oauth2.repository.redis.authorizationConsent.RedisOAuth2AuthorizationConsentService;
import com.anyilanxin.cloud.auth.oauth2.validate.impl.PictureValidate;
import com.anyilanxin.cloud.auth.oauth2.validate.impl.SmsValidate;
import com.anyilanxin.cloud.auth.utils.AnYiSecurityUtils;
