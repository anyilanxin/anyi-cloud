...
package com.anyilanxin.anyicloud.corecommon.utils.tree;
 ...
 * @author zxh
 */
public class AnYiTreeToolUtils<T extends BaseTree<T>> {
    /**
     * 默认子级键
     */
     ...
     */
    public AnYiTreeToolUtils(@Nonnull List<T> rootList, List<T> bodyList, @Nonnull TreeId<T> getTreeId) {
     ...
     */
    public AnYiTreeToolUtils(@Nonnull List<T> rootList, List<T> bodyList) {
     ...
     * @date 2020-08-26 18:08
     */
    public AnYiTreeToolUtils(@Nonnull List<T> rootList, List<T> bodyList, @Nonnull String idKey, @Nonnull String parentIdKey) {
        this.rootList = rootList;
        this.bodyList = bodyList;
        this.getTreeId = new TreeId<T>() {
            @Override
            public String getId(T t) {
                String jsonString = JSONObject.toJSONString(t, JSONWriter.Feature.WriteMapNullValue);
    ...
    public List<T> getTree() {
        if (CollUtil.isNotEmpty(bodyList) && CollUtil.isNotEmpty(rootList)) {
            ...
            return rootList;
        } else if (CollUtil.isNotEmpty(bodyList)) {
