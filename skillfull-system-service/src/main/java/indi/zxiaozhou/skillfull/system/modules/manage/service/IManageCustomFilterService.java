...
public interface IManageCustomFilterService extends BaseService<ManageCustomFilterEntity> {
     ...
     *
     * @param customFilterId ${@link String} 自定义过滤器id
     * @return ManageCustomFilterDto ${@link ManageCustomFilterDto} 查询结果
     * @throws RuntimeException ${@link RuntimeException}
     * @author zxiaozhou
     * @date 2021-12-19 00:22:15
     */
    ManageCustomFilterDto getById(String customFilterId) throws RuntimeException;
     ...
     *
     * @param serviceId ${@link String} 服务id
     * @return List<ManageCustomFilterDto> ${@link List<ManageCustomFilterDto>}
     * @author zxiaozhou zxiaozhou
     * @date 2021-12-19 09:21
     */
    List<ManageCustomFilterDto> selectList(String serviceId);
