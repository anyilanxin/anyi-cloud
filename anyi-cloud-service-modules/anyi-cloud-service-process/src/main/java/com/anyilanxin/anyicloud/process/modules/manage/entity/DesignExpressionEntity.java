...
@NoArgsConstructor
@TableName("act_custom_design_expression")
public class DesignExpressionEntity extends BaseEntity {
    @Serial
    private static final long serialVersionUID = -86628282774435515L;
    ...
    /**
     * 处理类型:0-人员,1-用户组,2-时间,3-条件,4-其他
     */
