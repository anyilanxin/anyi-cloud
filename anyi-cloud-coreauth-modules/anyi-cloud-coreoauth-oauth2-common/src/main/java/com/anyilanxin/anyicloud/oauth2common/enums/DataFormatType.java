 ...
 *
 * @author zxh
 * @date 2022-03-30 20:01
 * @since 1.0.0
 */
@Getter
@ConstantType
public enum DataFormatType implements ISuperType {
    /**
     * 标准
     */
    NORMAL(0, "标准"),
    ...
    DataFormatType(int type, String describe) {
        this.type = type;
    ...
    public static boolean isHaveByType(int type) {
        DataFormatType[] values = DataFormatType.values();
        for (DataFormatType value : values) {
            if (value.type == type) {
                return true;
            }
        }
    ...
    public List<ConstantDictModel> getConstantDict() {
        ...
        for (DataFormatType value : values) {
            ...
            dictDto.setType(String.valueOf(value.type));
