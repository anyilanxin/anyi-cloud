...
package com.anyilanxin.cloud.message.modules.announcement.controller;
...
public class AnnouncementRecordController extends AnYiBaseController {
    ...
    public AnYiResult<String> insert(@RequestBody @Valid AnnouncementRecordVo vo) {
        service.save(vo);
    ...
    public AnYiResult<String> update(@PathVariable(required = false) @PathNotBlankOrNull(message = "通知公告阅读记录id不能为空") String anntReadId, @RequestBody @Valid AnnouncementRecordVo vo) {
    ...
    public AnYiResult<String> deleteById(@PathVariable(required = false) @PathNotBlankOrNull(message = "通知公告阅读记录id不能为空") String anntReadId) {
    ...
    public AnYiResult<String> deleteBatchByIds(@RequestBody @NotNullSize(message = "待删除通知公告阅读记录id不能为空") List<String> anntReadIds) {
    ...
    public AnYiResult<AnnouncementRecordDto> getById(@PathVariable(required = false) @PathNotBlankOrNull(message = "通知公告阅读记录id不能为空") String anntReadId) {
    ...
    public AnYiResult<List<AnnouncementRecordDto>> selectListByModel(@RequestBody AnnouncementRecordQueryVo vo) {
    ...
    public AnYiResult<AnYiPageResult<AnnouncementRecordPageDto>> selectPage(@RequestBody AnnouncementRecordPageQuery vo) {
