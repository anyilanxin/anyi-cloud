 ...
 */
package com.anyilanxin.anyicloud.auth.oauth2.config.property;
...
@Data
@Configuration
@ConfigurationProperties(prefix = AnYiCustomSecurityProperties.PREFIX)
public class AnYiCustomSecurityProperties {

    static final String PREFIX = "anyi.custom.security";
     ...
     * 默认格式话数据类型
     */
    private DataFormatType defaultFormatType = DataFormatType.NORMAL;
