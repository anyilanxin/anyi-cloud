...
package com.anyilanxin.cloud.corewebflux.config.listener;
...
import com.anyilanxin.cloud.corewebflux.listener.RedisKeyDeleteEventMessageListener;
...
public class ConstantDeleteEventListener extends RedisKeyDeleteEventMessageListener {
    ...
    public ConstantDeleteEventListener(RedisMessageListenerContainer listenerContainer, ICoreWebfluxService coreCommonService) {
