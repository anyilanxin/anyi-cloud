    ...
    public static LoginUserInfoModel getUserAndAuthModel(String token) {
        ...
        if (Objects.nonNull(request)) {
            if (StringUtils.isNotBlank(token)) {
                Object attribute = request.getAttribute(SysBaseConstant.CONTENT_USER_INFO);
                if (Objects.nonNull(attribute) && attribute instanceof LoginUserInfoModel) {
                    return (LoginUserInfoModel) attribute;
                } else {
                    ...
                    if (Objects.nonNull(objectUserInfo) && objectUserInfo instanceof LoginUserInfoModel) {
                        LoginUserInfoModel andAuthModel = (LoginUserInfoModel) objectUserInfo;
                        request.setAttribute(SysBaseConstant.CONTENT_USER_INFO, andAuthModel);
                        return andAuthModel;
                    }
                }
        ...
        throw new ResponseException(Status.TOKEN_EXPIRED, "获取不到request信息");
    }
