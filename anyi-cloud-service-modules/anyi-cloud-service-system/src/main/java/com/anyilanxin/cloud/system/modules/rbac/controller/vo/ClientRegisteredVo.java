...
package com.anyilanxin.cloud.system.modules.rbac.controller.vo;

import com.anyilanxin.cloud.corecommon.model.auth.client.ClientBaseValidateModel;
...
@NoArgsConstructor
@Schema
public class ClientRegisteredVo extends ClientBaseValidateModel implements Serializable {
    @Serial
    private static final long serialVersionUID = -67437483239169736L;
    ...
    @NotBlankOrNull(message = "限制授权错误次数:0-不限制,1-限制。默认0不能为空")
    ...
    @NotBlankOrNull(message = "状态：0-未启用,1-启用，2-锁定，默认0不能为空")
