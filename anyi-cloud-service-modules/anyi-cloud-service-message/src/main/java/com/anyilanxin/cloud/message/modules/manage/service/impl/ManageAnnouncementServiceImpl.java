...
package com.anyilanxin.cloud.message.modules.manage.service.impl;
...
import com.anyilanxin.cloud.message.modules.manage.entity.ManageAnnouncementEntity;
import com.anyilanxin.cloud.message.modules.manage.mapper.ManageAnnouncementMapper;
...
import com.anyilanxin.cloud.message.modules.manage.service.mapstruct.ManageAnnouncementCopyMap;
import com.anyilanxin.cloud.message.modules.manage.service.mapstruct.ManageAnnouncementPageCopyMap;
import com.anyilanxin.cloud.message.modules.manage.service.mapstruct.ManageAnnouncementQueryCopyMap;
...
public class ManageAnnouncementServiceImpl extends ServiceImpl<ManageAnnouncementMapper, ManageAnnouncementEntity> implements IManageAnnouncementService {
    ...
    @Override
    @Transactional(rollbackFor = {Exception.class, Error.class}, readOnly = true)
    public AnYiPageResult<ManageAnnouncementPageDto> pageByModel(ManageAnnouncementPageQuery vo) throws RuntimeException {
    ...
    public void deleteBatch(List<String> anntIds) throws RuntimeException {
        var entities = this.listByIds(anntIds);
