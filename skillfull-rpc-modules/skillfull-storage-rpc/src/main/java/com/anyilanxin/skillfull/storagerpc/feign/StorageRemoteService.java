...
public interface StorageRemoteService {
    ...
    @Operation(
            ...
            description = "批量上传文件")
    @PostMapping(
            value = "/storage-file/upload-batch",
            consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    Result<List<StorageInfoModel>> uploadBatch(
