...
package com.anyilanxin.cloud.process.modules.manage.controller.vo;
...
public class DesignExpressionVo implements Serializable {
    ...
    @Schema(name = "handleType", title = "处理类型:0-人员,1-用户组,2-时间,3-条件,4-其他", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(name = "expressionName", title = "表达式名称", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotBlankOrNull(message = "表达式名称不能为空")
    private String expressionName;

    @Schema(name = "expressionType", title = "表达式类型:1-表达式,2-委托表达式", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotBlankOrNull(message = "表达式类型:1-表达式,2-委托表达式不能为空")
    private Integer expressionType;

    @Schema(name = "elExpressionValue", title = "El编码值,‘${’开头’}‘结尾，唯一", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotBlankOrNull(message = "El编码值,‘${’开头’}‘结尾，唯一不能为空")
    private String elExpressionValue;

    @Schema(name = "expressionState", title = "表达式状态:0-禁用,1-启用", requiredMode = Schema.RequiredMode.REQUIRED)
