...
package com.anyilanxin.cloud.auth.modules.login.service.dto;
...
@NoArgsConstructor
@Schema
public class ClientAndResourceAuthDto implements Serializable {
    @Serial
    ...
    @Schema(title = "允许授权类型，来源与授权中心常量字典AuthorizedGrantType,json array")
    private String authorizationGrantTypes;

    @Schema(title = "允许授权方法，具体与ClientAuthenticationMethod一致")
    ...
    @Schema(title = "客户端配置信息")
    private String clientSettings;

    @Schema(title = "推出登录后重定向url地址")
    private String postLogoutRedirectUris;

    @Schema(title = "登录重定向地址")
