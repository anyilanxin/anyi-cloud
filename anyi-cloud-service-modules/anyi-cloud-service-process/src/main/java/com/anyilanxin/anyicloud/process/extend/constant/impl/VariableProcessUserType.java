...
import com.anyilanxin.anyicloud.process.extend.constant.VariableProcessUserConstant;
...
@Getter
@ConstantType
public enum VariableProcessUserType implements ISuperType {
    /**
     * 登录人
     */
    LOGIN_USER(VariableProcessUserConstant.LOGIN_USER, "登录人"),

    /**
     * 流程发起人
     */
    PROCESS_INITIATE_USER(VariableProcessUserConstant.PROCESS_INITIATE_USER, "流程发起人");
    ...
    VariableProcessUserType(String type, String describe) {
        this.type = type;
    ...
    public static boolean isHaveByType(String type) {
        VariableProcessUserType[] values = VariableProcessUserType.values();
        for (VariableProcessUserType value : values) {
     ...
     * @date 2020-09-11 16:02
     */
    public static VariableProcessUserType getByType(String type) {
        VariableProcessUserType[] values = VariableProcessUserType.values();
        for (VariableProcessUserType value : values) {
            if (value.type.equals(type)) {
                return value;
