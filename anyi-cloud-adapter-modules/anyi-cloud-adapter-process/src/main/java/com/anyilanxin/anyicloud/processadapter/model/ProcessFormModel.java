...
public class ProcessFormModel implements Serializable {
    ...
    @Schema(name = "formJsonInfo", title = "表单json信息")
    private Map<String, Object> formJsonInfo;
    ...
    @Schema(name = "haveForm", title = "是否有表单")
    private boolean haveForm;

    @Schema(name = "type", title = "类型:0-自定义,1-camunda")
    private int type;
}
