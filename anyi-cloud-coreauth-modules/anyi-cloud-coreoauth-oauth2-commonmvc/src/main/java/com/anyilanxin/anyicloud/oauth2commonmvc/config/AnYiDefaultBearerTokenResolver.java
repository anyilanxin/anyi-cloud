...
/**
 * @author zxh
 * @date 2023-09-23 02:05
 * @since 1.0.0
 */
public class AnYiDefaultBearerTokenResolver implements BearerTokenResolver {

    private static final String ACCESS_TOKEN_QUERY_NAME_DEFAULT = "access_token";
    private String accessTokenQueryName = ACCESS_TOKEN_QUERY_NAME_DEFAULT;
    ...
    private String resolveFromRequestParameters(HttpServletRequest request) {
        String[] values = request.getParameterValues(this.accessTokenQueryName);
        if (values == null || values.length == 0) {
            values = request.getParameterValues(ACCESS_TOKEN_QUERY_NAME_DEFAULT);
            if (values == null || values.length == 0) {
                return null;
            }
        }
    ...
    private boolean hasAccessTokenInQueryString(HttpServletRequest request) {
        return (request.getQueryString() != null) && request.getQueryString().contains(this.accessTokenQueryName);
    }
