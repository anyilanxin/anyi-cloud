...
import com.anyilanxin.anyicloud.coreprocess.model.AttachmentInfoModel;
import com.anyilanxin.anyicloud.processadapter.constant.impl.CallbackType;
...
public class MsgSubmitProcessModel implements Serializable {
    ...
    @Schema(name = "messageName", title = "流程消息name", requiredMode = Schema.RequiredMode.REQUIRED)
