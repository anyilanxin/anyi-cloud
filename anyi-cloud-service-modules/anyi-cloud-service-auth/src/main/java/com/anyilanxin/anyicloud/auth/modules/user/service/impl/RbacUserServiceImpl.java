 ...
 */
package com.anyilanxin.anyicloud.auth.modules.user.service.impl;
...
import com.anyilanxin.anyicloud.auth.modules.user.mapper.RbacUserMapper;
import com.anyilanxin.anyicloud.auth.modules.user.service.IRbacUserService;
...
import com.anyilanxin.anyicloud.auth.modules.user.service.mapstruct.RbacUserCopyMap;
import com.anyilanxin.anyicloud.auth.modules.user.service.mapstruct.RbacUserPageCopyMap;
import com.anyilanxin.anyicloud.auth.modules.user.service.mapstruct.RbacUserQueryCopyMap;
...
public class RbacUserServiceImpl extends ServiceImpl<RbacUserMapper, RbacUserEntity> implements IRbacUserService {
    ...
    private final RbacUserPageCopyMap pageMap;
    private final RbacUserQueryCopyMap queryMap;
    ...
    public List<RbacUserDto> selectListByModel(RbacUserQueryVo vo) throws RuntimeException {
    ...
    @Override
    @Transactional(rollbackFor = {Exception.class, Error.class}, readOnly = true)
    public AnYiPageResult<RbacUserPageDto> pageByModel(RbacUserPageVo vo) throws RuntimeException {
    ...
    public void deleteBatch(List<String> userIds) throws RuntimeException {
        var entities = this.listByIds(userIds);
        ...
        entities.forEach(v -> waitDeleteList.add(v.getUserId()));
