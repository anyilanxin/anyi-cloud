  ...
  static void loadConstantDict(
    ...
    if (!force) {
      Object redisLockValue =
          redisTemplate.opsForValue().get(ICoreWebmvcService.REDIS_LOCK_KEY + serviceName);
    ...
    redisTemplate
        .opsForValue()
        .set(ICoreWebmvcService.REDIS_LOCK_KEY + serviceName, true, LOCK_EXPIRES, TimeUnit.SECONDS);
  }
}
