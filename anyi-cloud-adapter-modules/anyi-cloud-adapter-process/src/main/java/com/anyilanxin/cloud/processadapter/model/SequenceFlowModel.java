...
/**
 * 流程活动实例连线信息查询Response
 *
 * @author zxh
 * @copyright zhouxuanhong（https://anyilanxin.com）
 * @date 2022-10-06 09:36:46
 * @since 1.0.0
 */
@Getter
@Setter
...
public class SequenceFlowModel implements Serializable {
    ...
    @Schema(name = "sequenceFlowId", title = "连线实例信息id(实例id+连线bpmnId)")
    private String sequenceFlowId;

    @Schema(name = "sourceBpmnActivityId", title = "来源活动 id")
    ...
    @Schema(name = "sequenceFlowName", title = "连线名称")
