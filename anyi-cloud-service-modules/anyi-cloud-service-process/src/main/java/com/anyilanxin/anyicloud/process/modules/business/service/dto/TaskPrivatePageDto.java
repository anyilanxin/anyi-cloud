...
@NoArgsConstructor
public class TaskPrivatePageDto implements Serializable {
    @Serial
    ...
    @Schema(name = "createTime", title = "任务创建时间(支持排序)", example = "2020-12-21 12:22:21")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    ...
    @Schema(name = "category", title = "任务类型")
    private String category;

    @Schema(name = "id", title = "任务id")
    private String id;
    ...
    @Schema(name = "endTime", title = "审批结束时间", example = "2020-12-21 12:22:21")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
