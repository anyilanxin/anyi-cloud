...
/**
 * 部门角色-资源表(RbacOrgRoleResourceApi)持久层
 *
 * @author zxh
 ...
 */
@Repository
public interface RbacOrgRoleResourceApiMapper extends BaseMapper<RbacOrgRoleResourceApiEntity> {
    ...
    @Select("""
            ...
            """)
    Set<RbacResourceApiSimpleDto> selectResourceApiByUserId(@Param("userId") String userId, @Param("orgId") String orgId);
