...
package com.anyilanxin.anyicloud.corecommon.utils.excel.listener;
...
public class BasicExcelImportListener<I, R> extends AnalysisEventListener<I> {
    ...
    public void invoke(I i, AnalysisContext analysisContext) {
        log.debug("------------当前读取到的数据------{}------>\n{}", analysisContext.readRowHolder().getRowIndex(), JSONObject.toJSONString(i, JSONWriter.Feature.WriteMapNullValue));
    ...
    public void doAfterAllAnalysed(AnalysisContext analysisContext) {
        log.info("------------读取到的全部数据------------>\n{}", JSONObject.toJSONString(importData, JSONWriter.Feature.WriteMapNullValue));
        ...
        log.debug("------------数据处理返回结果------------>\n{}", JSONObject.toJSONString(saveData, JSONWriter.Feature.WriteMapNullValue));
    }
