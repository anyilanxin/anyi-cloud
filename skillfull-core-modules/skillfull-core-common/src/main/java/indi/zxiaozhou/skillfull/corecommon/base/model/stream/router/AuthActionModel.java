...
@AllArgsConstructor
@NoArgsConstructor
public class AuthActionModel implements Serializable {
    private static final long serialVersionUID = -2028750138891938444L;

    @Schema(name = "routeActions", title = "路由后端按钮权限指令,serviceId:path:ActionModel")
    private Map<String, Map<String, Set<ActionModel>>> routeActions;
