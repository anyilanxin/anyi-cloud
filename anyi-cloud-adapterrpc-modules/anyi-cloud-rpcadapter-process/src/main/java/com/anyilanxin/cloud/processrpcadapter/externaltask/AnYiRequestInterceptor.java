...
@Slf4j
@Component
public class AnYiRequestInterceptor implements ClientRequestInterceptor {
    ...
    public void intercept(ClientRequestContext requestContext) {
        ...
        if (StringUtils.isNotBlank(tokenToAuthService)) {
            requestContext.addHeader(AuthConstant.BEARER_TOKEN_HEADER_NAME, "Bearer " + tokenToAuthService);
        }
    }
}
