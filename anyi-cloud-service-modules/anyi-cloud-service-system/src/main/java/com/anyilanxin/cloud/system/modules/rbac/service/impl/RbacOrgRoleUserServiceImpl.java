...
import com.anyilanxin.cloud.system.modules.rbac.entity.RbacOrgRoleUserEntity;
...
import com.anyilanxin.cloud.system.modules.rbac.service.mapstruct.RbacOrgRoleUserCopyMap;
import com.anyilanxin.cloud.system.modules.rbac.service.mapstruct.RbacOrgRoleUserPageCopyMap;
import com.anyilanxin.cloud.system.modules.rbac.service.mapstruct.RbacOrgRoleUserQueryCopyMap;
...
public class RbacOrgRoleUserServiceImpl extends ServiceImpl<RbacOrgRoleUserMapper, RbacOrgRoleUserEntity> implements IRbacOrgRoleUserService {
    ...
    public void saveBatch(String userId, String orgId, Set<String> orgRoleIds) throws RuntimeException {
        if (CollUtil.isNotEmpty(orgRoleIds)) {
            ...
            if (!b) {
                throw new AnYiResponseException(AnYiResultStatus.DATABASE_BASE_ERROR, "保存机构角色关联失败");
            }
        }
    }
    ...
    public void deleteByUserId(String userId, String orgId) throws RuntimeException {
        ...
        if (CollUtil.isNotEmpty(list)) {
            ...
            int i = mapper.anyiPhysicalDeleteBatchIds(roleUserIds);
            if (i <= 0) {
