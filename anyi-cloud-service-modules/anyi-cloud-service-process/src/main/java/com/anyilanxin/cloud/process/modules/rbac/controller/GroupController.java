...
package com.anyilanxin.cloud.process.modules.rbac.controller;
...
import com.anyilanxin.cloud.process.modules.rbac.controller.vo.*;
import com.anyilanxin.cloud.process.modules.rbac.service.IGroupService;
import com.anyilanxin.cloud.process.modules.rbac.service.dto.GroupDto;
...
public class GroupController extends AnYiBaseController {
    ...
    public AnYiResult<String> saveOrUpdate(@RequestBody @Valid GroupVo vo) {
    ...
    public AnYiResult<String> deleteOrAddTenant(@RequestBody @Valid GroupTenantVo vo) {
    ...
    public AnYiResult<String> deleteById(@PathVariable(required = false) @PathNotBlankOrNull(message = "用户组id不能为空") String groupId) {
    ...
    public AnYiResult<String> syncGroup(@RequestBody @Valid Set<SyncGroupVo> voSet) {
    ...
    public AnYiResult<GroupDto> getById(@PathVariable(required = false) @PathNotBlankOrNull(message = "用户组id不能为空") String groupId) {
    ...
    public AnYiResult<List<GroupDto>> getList(@RequestBody GroupQueryVo vo) {
    ...
    public AnYiResult<AnYiPageResult<GroupDto>> selectPage(@RequestBody GroupQueryPageVoCamunda vo) {
