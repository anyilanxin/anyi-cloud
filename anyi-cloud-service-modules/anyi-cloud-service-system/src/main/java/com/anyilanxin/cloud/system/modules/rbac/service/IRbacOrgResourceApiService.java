...
/**
 * 机构-资源表(RbacOrgResourceApi)业务层接口
 *
 * @author zxh
 ...
 * @since 1.0.0
 */
public interface IRbacOrgResourceApiService extends BaseService<RbacOrgResourceApiEntity> {
    /**
     * 保存
     *
     * @param orgId          机构id
     * @param resourceApiIds 机构资源权限id
     * @throws RuntimeException
     * @author zxh
     * @date 2022-07-02 23:01:20
     */
    void save(String orgId, Set<String> resourceApiIds) throws RuntimeException;
     ...
     *
     * @param vo
     * @return AnYiPageResult<RbacResourceApiPageDto>
     * @author zxh
     * @date 2022-07-07 11:23
     */
    AnYiPageResult<RbacOrgResourceApiPageDto> selectResourcePage(RbacOrgResourceApiPageQuery vo);
}
