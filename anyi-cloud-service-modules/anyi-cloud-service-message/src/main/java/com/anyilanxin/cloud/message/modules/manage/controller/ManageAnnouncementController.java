...
import com.anyilanxin.cloud.message.modules.manage.controller.vo.ManageAnnouncementPageQuery;
import com.anyilanxin.cloud.message.modules.manage.controller.vo.ManageAnnouncementQueryVo;
import com.anyilanxin.cloud.message.modules.manage.controller.vo.ManageAnnouncementVo;
import com.anyilanxin.cloud.message.modules.manage.service.IManageAnnouncementService;
import com.anyilanxin.cloud.message.modules.manage.service.dto.ManageAnnouncementDto;
import com.anyilanxin.cloud.message.modules.manage.service.dto.ManageAnnouncementPageDto;
...
public class ManageAnnouncementController extends AnYiBaseController {
    ...
    public AnYiResult<String> insert(@RequestBody @Valid ManageAnnouncementVo vo) {
        service.save(vo);
    ...
    public AnYiResult<String> update(@PathVariable(required = false) @PathNotBlankOrNull(message = "通知公告id不能为空") String anntId, @RequestBody @Valid ManageAnnouncementVo vo) {
    ...
    public AnYiResult<String> deleteById(@PathVariable(required = false) @PathNotBlankOrNull(message = "通知公告id不能为空") String anntId) {
    ...
    public AnYiResult<String> deleteBatchByIds(@RequestBody @NotNullSize(message = "待删除通知公告id不能为空") List<String> anntIds) {
    ...
    public AnYiResult<ManageAnnouncementDto> getById(@PathVariable(required = false) @PathNotBlankOrNull(message = "通知公告id不能为空") String anntId) {
    ...
    public AnYiResult<List<ManageAnnouncementDto>> selectListByModel(@RequestBody ManageAnnouncementQueryVo vo) {
    ...
    public AnYiResult<AnYiPageResult<ManageAnnouncementPageDto>> selectPage(@RequestBody ManageAnnouncementPageQuery vo) {
