 ...
 * @since 2022-03-29 23:38:30
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE, builder = @Builder(disableBuilder = true))
public interface ChatMsgSessionAssociatedCopyMap extends BaseThreeMap<ChatMsgSessionAssociatedEntity, ChatMsgSessionAssociatedDto, ChatMsgSessionAssociatedVo> {
}
