...
public class EventPageDto implements Serializable {
    ...
    @Schema(name = "id", title = "事件id")
    private String id;

    @Schema(name = "revision", title = "修订版本")
    private int revision;

    @Schema(name = "eventType", title = "事件类型")
    private String eventType;

    @Schema(name = "eventTypeName", title = "事件类型名称")
    ...
    @Schema(name = "configuration", title = "配置信息")
    private String configuration;

    @Schema(name = "createTime", title = "创建时间(支持排序)", type = "string", example = "2020-12-21 12:22:21")
