...
// +----------------------------------------------------------------------
package com.anyilanxin.skillfull.gateway.filter.mapstruct;
...
public interface EncryptDecryptAndUserSecurityMap extends BaseMap<UserDataSecurityModel, EncryptDecryptModel> {
}