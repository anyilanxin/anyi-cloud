...
package com.anyilanxin.cloud.coremvc.utils;
...
public class AnYiUserContextUtils {
    private static AnYiUserContextUtils utils;
     ...
     * 根据token获取登录用户信息
     */
    public static AnYiUserInfo getUserInfo(String token) {
     ...
     * 获取登录用户信息
     */
    public static AnYiUserInfo getUserInfo() {
