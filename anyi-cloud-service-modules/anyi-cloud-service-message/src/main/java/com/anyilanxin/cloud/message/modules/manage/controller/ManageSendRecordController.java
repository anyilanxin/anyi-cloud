...
public class ManageSendRecordController extends AnYiBaseController {
    ...
    public AnYiResult<String> deleteById(@PathVariable(required = false) @PathNotBlankOrNull(message = "消息id不能为空") String sendRecordId) {
    ...
    public AnYiResult<String> deleteBatchByIds(@RequestBody @NotNullSize(message = "待删除消息id不能为空") List<String> sendRecordIds) {
    ...
    public AnYiResult<ManageSendRecordDto> getById(@PathVariable(required = false) @PathNotBlankOrNull(message = "消息id不能为空") String sendRecordId) {
    ...
    public AnYiResult<AnYiPageResult<ManageSendRecordPageDto>> selectPage(@RequestBody ManageSendRecordPageQuery vo) {
