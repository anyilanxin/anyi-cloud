...
public class ProcessCategoryController extends AnYiBaseController {
    private final IProcessCategoryService service;

    @Operation(summary = "流程类别添加", tags = {"v1.0.0"}, description = "添加流程类别")
    @PostMapping(value = "/insert")
    public AnYiResult<String> insert(@RequestBody @Valid ProcessCategoryVo vo) {
        service.save(vo);
    ...
    public AnYiResult<String> update(@PathVariable(required = false) @PathNotBlankOrNull(message = "类别id不能为空") String categoryId, @RequestBody @Valid ProcessCategoryVo vo) {
    ...
    public AnYiResult<String> deleteById(@PathVariable(required = false) @PathNotBlankOrNull(message = "类别id不能为空") String categoryId) {
    ...
    public AnYiResult<List<ProcessCategoryDto>> getList(@RequestBody ProcessCategoryQueryVo vo) {
    ...
    public AnYiResult<List<AnYiSelect>> getModelDesignList() {
    ...
    public AnYiResult<AnYiPageResult<ProcessCategoryPageDto>> selectPage(@RequestBody ProcessCategoryPageQuery vo) {
