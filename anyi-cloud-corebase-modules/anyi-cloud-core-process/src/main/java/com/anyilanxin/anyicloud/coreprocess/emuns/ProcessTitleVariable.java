...
@Getter
@ConstantType
public enum ProcessTitleVariable implements ISuperType {
    /**
     * 模型名称
     */
    ...
    ProcessTitleVariable(String variableKey, String describe) {
    ...
    public List<ConstantDictModel> getConstantDict() {
        ...
        ProcessTitleVariable[] values = ProcessTitleVariable.values();
        for (ProcessTitleVariable value : values) {
