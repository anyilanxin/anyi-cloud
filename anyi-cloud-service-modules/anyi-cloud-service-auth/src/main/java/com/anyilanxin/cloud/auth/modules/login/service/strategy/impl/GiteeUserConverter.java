 ...
 */
package com.anyilanxin.cloud.auth.modules.login.service.strategy.impl;

import com.anyilanxin.cloud.auth.modules.login.model.security.BasicOAuth2User;
import com.anyilanxin.cloud.auth.modules.login.service.strategy.Oauth2UserConverterStrategy;
import com.anyilanxin.cloud.auth.oauth2.constant.SecurityConstants;
...
public class GiteeUserConverter implements Oauth2UserConverterStrategy {
    ...
    public BasicOAuth2User convert(OAuth2User oAuth2User) {
        ...
        basicOauth2User.setType(SecurityConstants.THIRD_LOGIN_GITEE);
