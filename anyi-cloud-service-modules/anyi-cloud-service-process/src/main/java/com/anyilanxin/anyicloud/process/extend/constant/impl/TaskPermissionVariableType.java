...
@Getter
@ConstantType
public enum TaskPermissionVariableType implements ISuperType {
    /**
     * 任务权限限制机构
     */
    LIMIT_ORG("taskPermissionOrgId", "taskPermissionOrgId", "任务权限限制机构"),
    /**
     * 任务权限限制区域
     */
    LIMIT_AREA("taskPermissionAreaCode", "taskPermissionAreaCode", "任务权限限制区域");
    ...
    TaskPermissionVariableType(String type, String variableKey, String describe) {
        this.type = type;
    ...
    public static boolean isHaveByType(String type) {
        TaskPermissionVariableType[] values = TaskPermissionVariableType.values();
        for (TaskPermissionVariableType value : values) {
     ...
     * @date 2020-09-11 16:02
     */
    public static TaskPermissionVariableType getByType(String type) {
        TaskPermissionVariableType[] values = TaskPermissionVariableType.values();
        for (TaskPermissionVariableType value : values) {
            if (value.type.equals(type)) {
                return value;
