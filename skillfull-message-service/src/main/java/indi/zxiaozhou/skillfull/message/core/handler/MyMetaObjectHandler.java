...
public class MyMetaObjectHandler implements MetaObjectHandler {
    ...
    private LoginUserInfoModel getUser() {
        LoginUserInfoModel loginUserInfoModel = null;
        try {
            loginUserInfoModel = ContextHolderUtils.getUserAndAuthModel(ServletUtils.getSubToken());
        } catch (Exception e) {
            log.error("------------MyMetaObjectHandler------------>getUser--->\n参数:{}", "获取用户信息失败");
        }
