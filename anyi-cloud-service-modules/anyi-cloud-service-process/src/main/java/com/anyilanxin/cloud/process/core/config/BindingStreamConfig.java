...
package com.anyilanxin.cloud.process.core.config;
...
public class BindingStreamConfig {
    ...
    public Consumer<MsgSubmitProcessModel> submitProcess() {
        return payload -> {
            ...
            bindingComponent.out(BindingStreamConstant.SUBMIT_PROCESS_RESULT + BindingStreamConstant.OUT_SUFFIX, resultModel);
        };
    }
}
