...
import com.anyilanxin.cloud.coreprocess.emuns.UserTaskVariableType;
...
public class ProcessBusinessCommonServiceImpl implements IProcessBusinessCommonService {
    ...
    public ProcessBackModel getProcessBackInfo(String processInstanceId) {
        ...
        switch (Objects.requireNonNull(byStrState)) {
            case SUSPENDED:
                resultModel.setProcessState(com.anyilanxin.cloud.coreprocess.emuns.ProcessInstanceState.SUSPENDED);
                break;
            case COMPLETED:
                resultModel.setProcessState(com.anyilanxin.cloud.coreprocess.emuns.ProcessInstanceState.COMPLETED);
                break;
            case REFUSED:
                resultModel.setProcessState(com.anyilanxin.cloud.coreprocess.emuns.ProcessInstanceState.REFUSED);
                break;
            default:
                resultModel.setProcessState(com.anyilanxin.cloud.coreprocess.emuns.ProcessInstanceState.ACTIVE);
        }
        // 下一个节点审批信息
