...
import com.anyilanxin.cloud.oauth2common.utils.Oauth2CommonUtils;
...
public class PasswordUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String accountOrPhone) throws UsernameNotFoundException {
        var userDetails = Oauth2CommonUtils.toUserDetails(authService.getUserByAccountPhone(accountOrPhone));
