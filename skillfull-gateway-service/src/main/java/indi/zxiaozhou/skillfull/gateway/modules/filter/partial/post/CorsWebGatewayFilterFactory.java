...
import indi.zxiaozhou.skillfull.gateway.utils.CorsWebUtils;
...
import static indi.zxiaozhou.skillfull.corecommon.constant.CoreCustomGatewayFilterParamKeyConstant.PARAM_ENABLED_KEY;
...
public class CorsWebGatewayFilterFactory extends AbstractGatewayFilterFactory<CorsWebGatewayFilterFactory.Config> {
    ...
    private static class CorsWebGatewayFilter implements GatewayFilter, Ordered {
        ...
        @Override
        public int getOrder() {
            return FilterCustomPostType.CORS_WEB.getOrder();
        }
