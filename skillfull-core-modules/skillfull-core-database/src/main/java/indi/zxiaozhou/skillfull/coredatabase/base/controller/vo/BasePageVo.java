...
// +----------------------------------------------------------------------
package indi.zxiaozhou.skillfull.coredatabase.base.controller.vo;
...
public class BasePageVo implements Serializable {
    ...
    @Schema(name = "startTime", title = "开始时间", example = "2020-11-12 11:23")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm")
    private LocalDateTime startTime;

    @Schema(name = "endTime", title = "结束时间", example = "2020-12-12 11:23")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm")
    ...
    public <T> Page<T> getPage() {
        ...
        if (CollectionUtil.isNotEmpty(getAscs())) {
            ...
            if (CollectionUtil.isNotEmpty(getDescs())) {
