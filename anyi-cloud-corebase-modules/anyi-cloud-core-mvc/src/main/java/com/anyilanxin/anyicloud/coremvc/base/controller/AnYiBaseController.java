...
package com.anyilanxin.anyicloud.coremvc.base.controller;
...
public class AnYiBaseController {
     ...
     * @date 2020-06-22 17:16
     */
    public static AnYiResult<String> ok(String message) {
     ...
     * @date 2020-06-22 17:16
     */
    public static <T> AnYiResult<T> ok(T data) {
     ...
     * @date 2020-06-22 17:16
     */
    public static AnYiResult<Object> ok(AnYiResultStatus status) {
     ...
     * @date 2020-06-22 17:16
     */
    public static <T> AnYiResult<T> ok(T data, String message) {
     ...
     * @date 2020-06-22 17:17
     */
    public static <T> AnYiResult<T> fail(AnYiResultStatus status) {
        return new AnYiResult<>(status);
    }
     ...
     * @date 2020-06-22 17:17
     */
    public static <T> AnYiResult<T> fail(String message) {
     ...
     * @date 2020-06-22 17:17
     */
    public static <T> AnYiResult<T> fail(AnYiResultStatus status, String message) {
     ...
     * @date 2020-06-22 17:17
     */
    public static <T> AnYiResult<T> fail(Integer code, String message) {
