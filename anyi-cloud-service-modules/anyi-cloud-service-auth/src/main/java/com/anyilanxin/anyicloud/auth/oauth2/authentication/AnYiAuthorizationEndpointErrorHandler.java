...
package com.anyilanxin.anyicloud.auth.oauth2.authentication;
 ...
 * @since 1.0.0
 */
public class AnYiAuthorizationEndpointErrorHandler implements AuthenticationFailureHandler {
    @Override
    public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response, AuthenticationException exception) throws IOException, ServletException {
        ...
        if (dataTypeModel.getType() == DataFormatType.NORMAL) {
            ...
            ResponseUtils.writeResult(response, parameters, HttpStatus.UNAUTHORIZED);
            return;
        }
        ResponseUtils.writeResult(response, errorCode, AnYiResultStatus.ACCESS_DENIED);
    }
}
