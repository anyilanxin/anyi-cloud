...
import com.anyilanxin.anyicloud.job.modules.manage.controller.vo.JobInfoPageQuery;
import com.anyilanxin.anyicloud.job.modules.manage.controller.vo.JobInfoQueryVo;
import com.anyilanxin.anyicloud.job.modules.manage.controller.vo.JobInfoVo;
import com.anyilanxin.anyicloud.job.modules.manage.entity.JobInfoEntity;
import com.anyilanxin.anyicloud.job.modules.manage.mapper.JobInfoMapper;
import com.anyilanxin.anyicloud.job.modules.manage.service.IJobInfoService;
import com.anyilanxin.anyicloud.job.modules.manage.service.dto.JobInfoDto;
import com.anyilanxin.anyicloud.job.modules.manage.service.dto.JobInfoPageDto;
import com.anyilanxin.anyicloud.job.modules.manage.service.mapstruct.JobInfoCopyMap;
import com.anyilanxin.anyicloud.job.modules.manage.service.mapstruct.JobInfoPageCopyMap;
import com.anyilanxin.anyicloud.job.modules.manage.service.mapstruct.JobInfoQueryCopyMap;
...
public class JobInfoServiceImpl extends ServiceImpl<JobInfoMapper, JobInfoEntity> implements IJobInfoService {
    private final JobInfoCopyMap map;
    private final JobInfoPageCopyMap pageMap;
    private final JobInfoQueryCopyMap queryMap;
    private final JobInfoMapper mapper;

    @Override
    @Transactional(rollbackFor = {Exception.class, Error.class})
    public void save(JobInfoVo vo) throws RuntimeException {
        JobInfoEntity entity = map.vToE(vo);
    ...
    @Override
    @Transactional(rollbackFor = {Exception.class, Error.class})
    public void updateById(Integer id, JobInfoVo vo) throws RuntimeException {
        // 查询数据是否存在
        this.getById(id);
        // 更新数据
        JobInfoEntity entity = map.vToE(vo);
    ...
    public List<JobInfoDto> selectListByModel(JobInfoQueryVo vo) throws RuntimeException {
        List<JobInfoDto> list = mapper.selectListByModel(vo);
    ...
    @Override
    @Transactional(rollbackFor = {Exception.class, Error.class}, readOnly = true)
    public AnYiPageResult<JobInfoPageDto> pageByModel(JobInfoPageQuery vo) throws RuntimeException {
    ...
    @Override
    @Transactional(rollbackFor = {Exception.class, Error.class}, readOnly = true)
    public JobInfoDto getById(Integer id) throws RuntimeException {
        JobInfoEntity byId = super.getById(id);
    ...
    public void deleteBatch(List<Integer> ids) throws RuntimeException {
        List<JobInfoEntity> entities = this.listByIds(ids);
