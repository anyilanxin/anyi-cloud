...
import com.anyilanxin.anyicloud.oauth2commonmvc.utils.ResponseUtils;
...
import static com.anyilanxin.anyicloud.corecommon.utils.AnYiI18nUtil.getLocalMessage;

/**
 * 认证异常
 *
 * @author zxh
 * @date 2024-01-23 10:49
 * @since 1.0.0
 */
@Slf4j
public class AnYiJsonAuthenticationEntryPoint implements AuthenticationEntryPoint {
    ...
    static {
        ...
        LOCAL.put("Full authentication is required to access this resource", "CustomAccessDeniedHandler.accessIsDenied");
    }


    @Override
    public void commence(HttpServletRequest request, HttpServletResponse response, AuthenticationException authException) throws IOException {
        log.error("------------AnYiAuthenticationEntryPoint------------>handle:异常消息:\n{}", authException.getLocalizedMessage());
        ...
        ResponseUtils.writeResult(response, getLocalMessage(LOCAL, authException.getMessage()), AnYiResultStatus.ACCESS_ERROR);
    }
