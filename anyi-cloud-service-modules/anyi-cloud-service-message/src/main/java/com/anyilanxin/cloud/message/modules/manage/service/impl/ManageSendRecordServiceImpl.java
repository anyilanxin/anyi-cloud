...
import com.anyilanxin.cloud.message.modules.manage.controller.vo.ManageSendRecordPageQuery;
import com.anyilanxin.cloud.message.modules.manage.controller.vo.ManageSendRecordVo;
import com.anyilanxin.cloud.message.modules.manage.entity.ManageSendRecordEntity;
import com.anyilanxin.cloud.message.modules.manage.mapper.ManageSendRecordMapper;
import com.anyilanxin.cloud.message.modules.manage.service.IManageSendRecordService;
import com.anyilanxin.cloud.message.modules.manage.service.dto.ManageSendRecordDto;
import com.anyilanxin.cloud.message.modules.manage.service.dto.ManageSendRecordPageDto;
import com.anyilanxin.cloud.message.modules.manage.service.mapstruct.ManageSendRecordCopyMap;
...
public class ManageSendRecordServiceImpl extends ServiceImpl<ManageSendRecordMapper, ManageSendRecordEntity> implements IManageSendRecordService {
    ...
    public AnYiPageResult<ManageSendRecordPageDto> pageByModel(ManageSendRecordPageQuery vo) throws RuntimeException {
    ...
    public ManageSendRecordDto getById(String sendRecordId) throws RuntimeException {
        var byId = super.getById(sendRecordId);
    ...
    public void deleteById(String sendRecordId) throws RuntimeException {
        ...
        // 删除数据
        var b = this.removeById(sendRecordId);
        if (!b) {
    ...
    public void deleteBatch(List<String> sendRecordIds) throws RuntimeException {
        var entities = this.listByIds(sendRecordIds);
