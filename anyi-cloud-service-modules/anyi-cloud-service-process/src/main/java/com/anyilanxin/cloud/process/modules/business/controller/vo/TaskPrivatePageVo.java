...
import com.anyilanxin.cloud.process.core.base.controller.vo.CamundaDateBasePageVo;
...
@NoArgsConstructor
public class TaskPrivatePageVo extends CamundaDateBasePageVo implements Serializable {
    @Serial
    ...
    @Schema(name = "taskFormEquals", title = "任务表单模糊匹配查询字段")
    private Map<String, String> taskFormLike;

    @Schema(name = "taskFormTime", title = "任务表单时间匹配")
    private Map<String, QueryTimeVo> taskFormTime;
