...
package com.anyilanxin.cloud.process.modules.manage.mapper;
...
public interface DesignExpressionMapper extends BaseMapper<DesignExpressionEntity> {
     ...
     * 分页查询
     *
     * @param vo   ${@link DesignExpressionPageQuery} 查询条件
     ...
     * @date 2022-03-27 00:20:29
     */
    IPage<DesignExpressionPageDto> pageByModel(Page<DesignExpressionPageDto> page, @Param("query") DesignExpressionPageQuery vo);
}
