...
import com.anyilanxin.cloud.job.modules.manage.controller.vo.JobLogReportVo;
 ...
 * @since 1.0.0
 */
public interface IJobLogReportService extends BaseService<JobLogReportEntity> {
    /**
     * 保存
     *
     * @param vo 保存数据
     ...
     * @date 2022-06-25 00:41:59
     */
    void save(JobLogReportVo vo) throws RuntimeException;
     ...
     * @date 2022-06-25 00:41:59
     */
    void updateById(Integer id, JobLogReportVo vo) throws RuntimeException;
     ...
     *
     * @param vo 分页查询条件
     * @return AnYiPageResult<JobLogReportPageDto> 分页查询结果
     * @throws RuntimeException
     * @author zxh
     * @date 2022-06-25 00:41:59
     */
    AnYiPageResult<JobLogReportPageDto> pageByModel(JobLogReportPageQuery vo) throws RuntimeException;
     ...
     * @date 2022-06-25 00:41:59
     */
    List<JobLogReportDto> selectListByModel(JobLogReportQueryVo vo) throws RuntimeException;
     ...
     *
     * @param id job报告日志id
     * @return JobLogReportDto 查询结果
     * @throws RuntimeException
     * @author zxh
     * @date 2022-06-25 00:41:59
     */
    JobLogReportDto getById(Integer id) throws RuntimeException;
