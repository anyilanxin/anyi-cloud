...
public class ManageServiceController extends BaseController {
    ...
    @Operation(
            summary = "获取需要聚合swagger的路由信息",
            tags = {"v1.0.0"},
            description = "获取需要聚合swagger的路由信息")
    ...
    @Operation(
            summary = "服务实例分页查询",
            tags = {"v1.0.0"},
            description = "服务实例分页查询")
    @PostMapping(value = "/select-instance/page")
    public Result<PageDto<ServiceInstancePageDto>> selectInstancePage(
            @RequestBody InstancePageVo vo) {
    ...
    @Operation(
            summary = "请求安全基础信息手动刷新",
            tags = {"v1.0.0"},
            description = "请求安全基础信息手动刷新")
