...
public class RbacClientDetailsController extends BaseController {
    ...
    @Operation(
            summary = "授权客户端信息逻辑批量删除",
            tags = {"v1.0.0"},
            description = "批量删除授权客户端信息")
    @PostMapping(value = "/delete-batch")
    public Result<String> deleteBatchByIds(
            @RequestBody @NotNullSize(message = "待删除客户端信息id不能为空") List<String> clientDetailIds) {
        service.deleteBatch(clientDetailIds);
        return ok(I18nUtil.get("Controller.BatchDeleteSuccess"));
    }

    @Operation(
            summary = "通过客户端信息id查询详情",
            tags = {"v1.0.0"},
            description = "查询授权客户端信息详情")
    @Parameter(
            in = ParameterIn.PATH,
            description = "客户端信息id",
            name = "clientDetailId",
    ...
    @Operation(
            summary = "授权客户端信息分页查询",
            tags = {"v1.0.0"},
            description = "分页查询授权客户端信息")
    @PostMapping(value = "/select/page")
    public Result<PageDto<RbacClientDetailsPageDto>> selectPage(
            @RequestBody RbacClientDetailsPageVo vo) {
