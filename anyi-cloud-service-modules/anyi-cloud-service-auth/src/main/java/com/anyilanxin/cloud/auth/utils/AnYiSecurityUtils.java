...
import com.anyilanxin.cloud.auth.oauth2.AnYiLoginUrlAuthenticationEntryPoint;
import com.anyilanxin.cloud.auth.oauth2.authentication.AnYiAuthorizationEndpointErrorHandler;
import com.anyilanxin.cloud.auth.oauth2.authentication.client.AnYiClientSecretAuthenticationProvider;
import com.anyilanxin.cloud.auth.oauth2.authentication.client.AnYiClientSecretPostAuthenticationConverter;
import com.anyilanxin.cloud.auth.oauth2.authentication.device.DeviceClientAuthenticationConverter;
import com.anyilanxin.cloud.auth.oauth2.authentication.device.DeviceClientAuthenticationProvider;
import com.anyilanxin.cloud.auth.oauth2.authentication.tokenendpoint.authorizationcode.AnYiOAuth2AuthorizationCodeAuthenticationConverter;
import com.anyilanxin.cloud.auth.oauth2.authentication.tokenendpoint.authorizationcode.AnYiOAuth2AuthorizationCodeAuthenticationProvider;
import com.anyilanxin.cloud.auth.oauth2.authentication.tokenendpoint.clientcredentials.AnYiOAuth2ClientCredentialsAuthenticationConverter;
import com.anyilanxin.cloud.auth.oauth2.authentication.tokenendpoint.clientcredentials.AnYiOAuth2ClientCredentialsAuthenticationProvider;
import com.anyilanxin.cloud.auth.oauth2.authentication.tokenendpoint.devicecode.AnYiOAuth2DeviceCodeAuthenticationConverter;
import com.anyilanxin.cloud.auth.oauth2.authentication.tokenendpoint.devicecode.AnYiOAuth2DeviceCodeAuthenticationProvider;
import com.anyilanxin.cloud.auth.oauth2.config.property.AnYiCustomSecurityProperties;
import com.anyilanxin.cloud.auth.oauth2.handler.ConsentAuthenticationFailureHandler;
import com.anyilanxin.cloud.auth.oauth2.handler.DeviceAuthorizationResponseHandler;
import com.anyilanxin.cloud.auth.oauth2.token.AnYiTokenEndpointErrorHandler;
import com.anyilanxin.cloud.auth.oauth2.token.AnYiTokenEndpointResponseHandler;
