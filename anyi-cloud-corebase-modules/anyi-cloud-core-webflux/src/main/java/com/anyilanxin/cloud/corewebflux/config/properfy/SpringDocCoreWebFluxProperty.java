...
package com.anyilanxin.cloud.corewebflux.config.properfy;
...
import static com.anyilanxin.cloud.corecommon.constant.CommonCoreConstant.GRAY_HEADER_KEY;
...
public class SpringDocCoreWebFluxProperty {
    ...
    public Set<String> getHeaders() {
        ...
        headers.add(AuthConstant.BEARER_TOKEN_HEADER_NAME);
        // 灰度信息key
