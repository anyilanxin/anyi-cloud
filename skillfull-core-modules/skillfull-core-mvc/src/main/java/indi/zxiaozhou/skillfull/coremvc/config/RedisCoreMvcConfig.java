...
import indi.zxiaozhou.skillfull.coremvc.constant.CommonCoreMvcConstant;
...
public class RedisCoreMvcConfig {
    ...
    public CacheManager cacheManager() {
        ...
        return RedisCacheManager.builder(RedisCacheWriter.lockingRedisCacheWriter(redisConnectionFactory)).cacheDefaults(redisCacheConfiguration)
                .withInitialCacheConfigurations(singletonMap(CommonCoreMvcConstant.TEST_DEMO_CACHE, RedisCacheConfiguration.defaultCacheConfig().entryTtl(Duration.ofMinutes(5)).disableCachingNullValues()))
