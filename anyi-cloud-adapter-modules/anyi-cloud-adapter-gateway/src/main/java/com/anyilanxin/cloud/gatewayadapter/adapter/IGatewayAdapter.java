...
package com.anyilanxin.cloud.gatewayadapter.adapter;
...
public interface IGatewayAdapter {
     ...
     */
    List<RouteResponseModel> getRoutes();
     ...
     */
    List<JSONObject> getOriginalRoutes();
     ...
     */
    void addRoute(SystemRouterModel vo);
     ...
     */
    void updateRoute(SystemRouterModel vo);
