...
package com.anyilanxin.cloud.loggingcommon.utils;
...
import com.anyilanxin.cloud.stream.component.BindingComponent;
import com.anyilanxin.cloud.stream.constant.BindingStreamConstant;
...
@Component
public class AnYiLogUtils {
    @Value("${spring.application.name:unknown}")
    private String serviceName;
    @Value("${spring.application.version:unknown}")
    private String applicationVersion;

    private static AnYiLogUtils utils;
    ...
    public static void sendOperateLog(OperateLogModel operateLogModel) {
        if (Objects.nonNull(operateLogModel)) {
            ...
            if (Objects.nonNull(operateLogModel.getRequestStartTime()) && Objects.nonNull(operateLogModel.getRequestEndTime())) {
                ...
                operateLogModel.setCostTimeStr(DateUtil.formatBetween(operateLogModel.getCostTime(), BetweenFormatter.Level.MILLISECOND));
            }
    ...
    public static void sendAuthLog(AuthLogModel authLogModel) {
        if (Objects.nonNull(authLogModel)) {
            if (Objects.nonNull(authLogModel.getRequestStartTime()) && Objects.nonNull(authLogModel.getRequestEndTime())) {
                ...
                authLogModel.setCostTimeStr(DateUtil.formatBetween(authLogModel.getCostTime(), BetweenFormatter.Level.MILLISECOND));
            }
