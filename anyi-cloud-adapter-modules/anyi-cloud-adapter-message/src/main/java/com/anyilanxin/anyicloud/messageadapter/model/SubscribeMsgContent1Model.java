...
@NoArgsConstructor
public class SubscribeMsgContent1Model extends SocketMsgContent1Model {
    @Serial
     ...
     * 发送用户信息
     */
    private AnYiUserInfo sendUserInfo;
    ...
    public SubscribeMsgContent1Model(SocketMessageEventType eventType) {
        super(eventType);
    }
}
