...
@NoArgsConstructor
@Schema
public class JobLoggluePageQuery extends AnYiPageQuery {
    @Serial
    private static final long serialVersionUID = -87469620190073112L;

    @Schema(name = "id", title = "logglue id")
    private Integer id;
