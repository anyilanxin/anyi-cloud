...
public interface IEventBusinessService {
     ...
     * 触发信号事件
     *
     * @param vo ${@link SignalEventVo}
     * @throws RuntimeException ${@link RuntimeException}
     * @author zxh
     * @date 2022-03-23 12:03
     */
    void signalEvent(SignalEventVo vo) throws RuntimeException;


    /**
     * 触发消息事件
     *
     * @param vo ${@link MessageEventVo}
     * @throws RuntimeException ${@link RuntimeException}
     * @author zxh
     * @date 2022-03-23 12:03
     */
    void messageEvent(MessageEventVo vo) throws RuntimeException;


    /**
     * 分页查询事件
     *
     * @param vo ${@link EventPageVo}
     * @return AnYiPageResult<EventPageDto> ${@link AnYiPlusPageResult < EventPageDto >}
     * @throws RuntimeException ${@link RuntimeException}
     * @author zxh
     * @date 2022-03-23 12:04
     */
    AnYiPageResult<EventPageDto> selectEventPage(EventPageVo vo) throws RuntimeException;
}
