...
public class ClientCredentialsTokenGranter extends AbstractTokenGranter {
    ...
    public ClientCredentialsTokenGranter(
        ...
        super(
                ...
                requestFactory,
                AuthorizedGrantTypes.CLIENT_CREDENTIALS.getType());
    ...
    protected OAuth2Authentication getOAuth2Authentication(
        ...
        ClientCredentialsAuthenticationToken credentialsAuthenticationToken =
                new ClientCredentialsAuthenticationToken(clientId, clientSecurity);
        Authentication authenticate =
                authenticationManager.authenticate(credentialsAuthenticationToken);
