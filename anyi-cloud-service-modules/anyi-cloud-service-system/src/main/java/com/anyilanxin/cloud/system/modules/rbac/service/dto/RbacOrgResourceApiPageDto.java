...
@NoArgsConstructor
@Schema
public class RbacOrgResourceApiPageDto implements Serializable {
    @Serial
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RbacOrgResourceApiPageDto)) {
            return false;
        }
        RbacOrgResourceApiPageDto that = (RbacOrgResourceApiPageDto) o;
        return Objects.equals(getApiId(), that.getApiId());
    }
