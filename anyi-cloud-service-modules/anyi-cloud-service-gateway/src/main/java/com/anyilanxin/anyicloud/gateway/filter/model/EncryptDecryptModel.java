...
package com.anyilanxin.anyicloud.gateway.filter.model;
...
@NoArgsConstructor
public class EncryptDecryptModel implements Serializable {
    @Serial
    ...
    @Schema(name = "secretKey", title = "密钥放入body或query时的key")
    ...
    @Schema(name = "success", title = "获取是否成功")
