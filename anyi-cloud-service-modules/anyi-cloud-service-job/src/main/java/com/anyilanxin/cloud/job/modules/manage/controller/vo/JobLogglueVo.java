...
/**
 * job logglue添加或修改Request
 *
 * @author zxh
 * @copyright zhouxuanhong（https://anyilanxin.com）
 * @date 2022-06-25 00:42:01
 * @since 1.0.0
 */
@Getter
@Setter
...
public class JobLogglueVo implements Serializable {
    @Serial
    private static final long serialVersionUID = -51478869070213850L;
    ...
    @Schema(name = "glueRemark", title = "GLUE备注", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotBlankOrNull(message = "GLUE备注不能为空")
