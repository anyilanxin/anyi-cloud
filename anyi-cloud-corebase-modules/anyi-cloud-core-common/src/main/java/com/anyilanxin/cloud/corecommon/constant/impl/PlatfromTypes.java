...
package com.anyilanxin.cloud.corecommon.constant.impl;
...
@Getter
@ConstantType
public enum PlatfromTypes implements ISuperType {

    /**
     * cloud zeebe
     */
    CLOUD_ZEEBE("cloudzeebe", "cloud zeebe"),
    ...
    PlatfromTypes(String type, String describe) {
        this.type = type;
     ...
     */
    public static PlatfromTypes getByType(String type) {
        PlatfromTypes[] values = PlatfromTypes.values();
        for (PlatfromTypes value : values) {
