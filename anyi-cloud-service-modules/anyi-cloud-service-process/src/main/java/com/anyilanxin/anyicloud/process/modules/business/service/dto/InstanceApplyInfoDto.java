...
@NoArgsConstructor
public class InstanceApplyInfoDto {
    ...
    @Schema(name = "processStartTime", title = "流程发起时间(支持排序)", example = "2020-12-21 12:22:21")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    private LocalDateTime processStartTime;

    @Schema(name = "processEndTime", title = "流程结束时间(支持排序)", example = "2020-12-21 12:22:21")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    ...
    @Schema(name = "userInfo", title = "流程申请人完整信息")
