...
@Getter
@ConstantType
public enum ProcessPermissionVariableType implements ISuperType {
    /**
     * 流程权限限制机构
     */
    LIMIT_ORG("processPermissionOrgId", "processPermissionOrgId", "流程权限限制机构"),
    /**
     * 流程权限限制区域
     */
    LIMIT_AREA("processPermissionAreaCode", "processPermissionAreaCode", "流程权限限制区域");
    ...
    ProcessPermissionVariableType(String type, String variableKey, String describe) {
        this.type = type;
    ...
    public static boolean isHaveByType(String type) {
        ProcessPermissionVariableType[] values = ProcessPermissionVariableType.values();
        for (ProcessPermissionVariableType value : values) {
     ...
     * @date 2020-09-11 16:02
     */
    public static ProcessPermissionVariableType getByType(String type) {
        ProcessPermissionVariableType[] values = ProcessPermissionVariableType.values();
        for (ProcessPermissionVariableType value : values) {
            if (value.type.equals(type)) {
                return value;
