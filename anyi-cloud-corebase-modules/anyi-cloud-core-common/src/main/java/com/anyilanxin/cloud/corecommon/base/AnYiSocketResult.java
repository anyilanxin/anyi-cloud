...
package com.anyilanxin.cloud.corecommon.base;

import com.alibaba.fastjson2.JSONObject;
import com.anyilanxin.cloud.corecommon.constant.impl.BusinessType;
import com.anyilanxin.cloud.corecommon.constant.impl.SocketMsgType;
...
public class AnYiSocketResult implements Serializable {
    @Serial
    ...
    public AnYiSocketResult(BusinessType businessType) {
    ...
    public AnYiSocketResult(BusinessType businessType, Object data) {
        this(businessType);
        this.data = data;
    }


    public AnYiSocketResult setMsgType(SocketMsgType msgType) {
        this.msgType = msgType.getType();
        return this;
    }


    public AnYiSocketResult setData(Object data) {
        this.data = data;
        return this;
    }


    public AnYiSocketResult setMessage(String message) {
        this.message = message;
        return this;
    }


    public AnYiSocketResult setRequestMarker(String requestMarker) {
        this.requestMarker = requestMarker;
        return this;
    }


    public AnYiSocketResult setUserId(String userId) {
    ...
    public AnYiSocketResult setUserIds(List<String> userIds) {
        this.userIds = userIds;
        return this;
    }


    public AnYiSocketResult setSystemId(String loginCode) {
    ...
    public AnYiSocketResult setSystemIds(List<String> loginCodes) {
