...
public class LoginRouteTreeModel extends BaseTree<LoginRouteTreeModel> implements Serializable, Comparable<LoginRouteTreeModel> {
    ...
    @Schema(name = "permissionSysCode", title = "系统内置编码(系统自动生成)", hidden = true)
    @JsonIgnore
    ...
    @Override
    public int compareTo(LoginRouteTreeModel o) {
