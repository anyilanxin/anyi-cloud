...
package com.anyilanxin.cloud.message.modules.announcement.controller.vo;
...
@NoArgsConstructor
@Schema
public class AnnouncementRecordPageQuery extends AnYiPageQuery {
    @Serial
    private static final long serialVersionUID = 716898468493570077L;
