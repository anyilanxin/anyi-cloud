...
@Tag(name = "ManageCustomFilter", description = "自定义过滤器Api接口相关")
...
public class ManageCustomFilterController extends BaseController {
    ...
    public Result<ManageCustomFilterDto> getById(@PathVariable(required = false) @PathNotBlankOrNull(message = "自定义过滤器id不能为空") String customFilterId) {
    ...
    public Result<List<ManageCustomFilterDto>> selectList(@PathVariable(required = false) @PathNotBlankOrNull(message = "服务id不能为空") String serviceId) {
