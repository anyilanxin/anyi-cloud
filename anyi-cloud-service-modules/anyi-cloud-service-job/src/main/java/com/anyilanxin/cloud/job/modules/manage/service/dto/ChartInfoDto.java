...
public class ChartInfoDto implements Serializable {
    @Serial
    private static final long serialVersionUID = -57633929765949895L;

    @Schema(name = "triggerDayList", title = "时间轴")
    private List<String> triggerDayList;

    @Schema(name = "triggerDayCountRunningList", title = "运行中")
    private List<Integer> triggerDayCountRunningList;

    @Schema(name = "triggerDayCountSucList", title = "成功")
    private List<Integer> triggerDayCountSucList;

    @Schema(name = "triggerDayCountFailList", title = "失败")
    private List<Integer> triggerDayCountFailList;

    @Schema(name = "triggerCountRunningTotal", title = "进行中数量")
    private int triggerCountRunningTotal;

    @Schema(name = "triggerCountSucTotal", title = "成功数量")
    private int triggerCountSucTotal;

    @Schema(name = "triggerCountFailTotal", title = "失败数量")
