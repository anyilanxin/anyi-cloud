...
public class ServletUtils {
     ...
     */
    public static String getSubToken(HttpServletRequest request) {
        String token = request.getHeader(SysBaseConstant.SUB_HEADER_TOKEN_KEY);
        if (StringUtils.isBlank(token)) {
            token = request.getParameter(SysBaseConstant.SUB_QUERY_TOKEN_KEY);
        }
        if (StringUtils.isBlank(token)) {
            token = "";
        }
    ...
    public static String getSubToken() {
        return getSubToken(utils.request);
    }
