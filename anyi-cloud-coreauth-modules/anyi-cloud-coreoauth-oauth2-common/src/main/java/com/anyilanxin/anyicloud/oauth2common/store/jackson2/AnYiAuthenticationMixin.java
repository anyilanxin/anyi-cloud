...
abstract class AnYiAuthenticationMixin {

    @JsonCreator
    AnYiAuthenticationMixin(
            @JsonProperty("authorizationGrantType") AuthorizationGrantType authorizationGrantType,
            @JsonProperty("authorizedScopes") List<String> authorizedScopes,
            @JsonProperty("clientInfo") AnYiAuthClientModel clientInfo,
