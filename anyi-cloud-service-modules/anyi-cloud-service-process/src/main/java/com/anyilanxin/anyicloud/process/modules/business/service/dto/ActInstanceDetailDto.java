...
@NoArgsConstructor
public class ActInstanceDetailDto implements Serializable, Comparable<ActInstanceDetailDto> {
    @Serial
    ...
    @Schema(name = "taskFormInfo", title = "任务表单")
    ...
    @Override
    public int compareTo(ActInstanceDetailDto o) {
