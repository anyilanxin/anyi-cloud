...
@NoArgsConstructor
public class ActInstanceAndModelDto implements Serializable {
    @Serial
    ...
    @Schema(name = "actInstanceMap", title = "流程act信息，map key为流程模型节点id")
    private Map<String, ActInstanceDto> actInstanceMap;
}
