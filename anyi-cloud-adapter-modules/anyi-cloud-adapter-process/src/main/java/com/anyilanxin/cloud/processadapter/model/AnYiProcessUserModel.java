...
import com.anyilanxin.cloud.coreprocess.model.AnYiProcessSimpleUserModel;
...
@NoArgsConstructor
@Schema
public class AnYiProcessUserModel extends AnYiProcessSimpleUserModel implements Serializable {
    @Serial
